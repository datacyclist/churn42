...
col_sr_named <- c("red1"="#AA1937", "red2"="#E6003C", "yellow2"="#FAA600", "yellow3"="#FFC805")
col_sr_unnamed <- c("#AA1937","#E6003C", "#FAA600", "#FFC805")

pal_sr <- newpal(c("#AA1937", "#E6003C", "#FAA600", "#FFC805"))

# text size für geom_text()
bartextsize <- 8

theme_sr <- function(base_size = 24, base_family = "") {
				  theme(
