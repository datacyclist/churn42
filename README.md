...
predict churn for the next quarter (Q3 2021) from the data in the first two
quarters. In other words, the task consists of identifying which customers are
most likely going to churn in the next quarter. By doing so, the company can
